...
const StructureQuestions: Questions[] = [
  ...
  },
  {
    ...
    answers: [
      ...
      { icon: <Calendar />, label: 'Dauer wird anhand von Runden definiert', name: 'durationRound', inputType: 'number', info: 'Bitte geben Sie die reservierbaren Dauern ein z.B. 60 Min.', onDay: false, isMultiField: false, placeholder: 'Die Runde dauert z.B.: 60 Min.' },
      { icon: <Calendar />, label: 'Tagesanhängig, feste Zeiten', name: 'onDayDurationTime', inputType: 'number', info: 'Bitte geben Sie die reservierbaren Dauern ein z.B. 60 Minuten, 90 etc. Sollte es sich um Runden handeln, setzen Sie den Haken und geben nur die Dauer einer durchschnittlichen Runde an.', onDay: true, isMultiField: false, placeholder: 'z.B.: 60 Min.' },
      { icon: <Calendar />, label: 'Tagesanhängig, Runden oder feste Zeiten', name: 'onDayDuration', inputType: 'number', info: 'Bitte geben Sie die reservierbaren Dauern ein z.B. 60 Minuten, 90 etc. Sollte es sich um Runden handeln, setzen Sie den Haken und geben nur die Dauer einer durchschnittlichen Runde an.', onDay: true, isMultiField: false, placeholder: 'z.B.: 60 Min.' },
