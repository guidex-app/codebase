...
const Check: FunctionalComponent<CheckProp> = ({ activity }: CheckProp) => {
  const checkListItems = [
    ...
    { title: 'Definiere Deine Leistungen', description: 'Welche Leistungen stellt ihr zur verfügung', color: 'danger', link: 'services', check: !activity.state?.includes('services') },
