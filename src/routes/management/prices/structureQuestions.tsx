import { IconBoxMultiple1, IconBoxMultiple2, IconBoxMultiple3, IconBoxMultiple4, IconBoxMultiple5, IconBoxMultiple6, IconBoxMultiple7, IconCalendar } from '@tabler/icons';
...
const StructureQuestions: Questions[] = [
  ...
  //     icon: <IconCalendar color="#63e6e1" />,
  //     type: 'onOpenings',
  //     availableActivated: true,
  //     availableText: 'Nein, die Preise sind jeden Tag gleich',
  //   },
  //   answers: [
  //     { icon: <IconCalendar />, label: 'Ja, die Preise sind an bestimmten Tagen unterschiedlich', name: 'day', inputType: 'dayPicker', info: 'Bitte bilden sie Tagesgruppen. Innerhalb der Tagesgruppen, gelten die gleichen Bedingungen für alle enthaltenen Preise.', onDay: false, isMultiField: false },
  //   ],
  // },
  {
    info: {
      ...
      icon: <IconBoxMultiple1 color="#ff5613" />,
      type: 'radio',
      availableActivated: true,
      availableText: 'Nein, der Preis ist für alle Altersgruppen gleich',
    },
    answers: [
      { icon: <IconCalendar />, label: 'Ja, der Preis variiert bei bestimmten Altersgruppen', name: 'age', inputType: 'number', info: 'Bitte geben sie an, bei welchem Alter andere Preise gelten.', onDay: false, isMultiField: true, placeholder: 'Von: 6 (Jahre) / Bis: 14 (Jahre)' },
      { icon: <IconCalendar />, label: 'Ja, aber nur an bestimmten Tagen varriiert der Preis, je nach Alter.', name: 'onDayAge', inputType: 'number', info: 'Bitte wählen sie die Tage aus, an denen andere Preise für folgende Altersgruppen gelten.', onDay: true, isMultiField: true, placeholder: 'Bis: 6 (Jahre)" / Bis: 14 (Jahre)' },
    ],
  },
  {
    info: {
      ...
      icon: <IconBoxMultiple2 color="#63d2ff" />,
      type: 'radio',
      availableActivated: true,
      availableText: 'Nein, die Preise sind nicht abhängig von der Uhrzeit',
    },
    answers: [
      { icon: <IconCalendar />, label: 'Ja, die Preise variieren bei folgenden Uhrzeiten.', name: 'time', inputType: 'time', info: 'Hier geht es darum, ob sich die Preise je nach Uhrzeit verändern z.B. 14 Uhr bis 17:00 Uhr, 18:00-22:00 etc.', onDay: false, isMultiField: true, placeholder: 'z.B.: 14:00 Uhr / z.B.: 17:00 Uhr' },
      { icon: <IconCalendar />, label: 'Ja, aber nur an bestimmten Tagen varriiert der Preis, je nach Uhrzeit.', name: 'onDayTime', inputType: 'time', info: 'Hier geht es darum, ob sich die Preise nur an bestimmten Tagen je nach Uhrzeit verändern.', onDay: true, isMultiField: true, placeholder: 'z.B.: 14:00 Uhr / z.B.: 17:00 Uhr' },
    ],
  },
  {
    info: {
      ...
      advice: '',
      icon: <IconBoxMultiple3 color="#2fd159" />,
      type: 'simple',
      availableActivated: false,
      availableText: 'Der Preis wird pro Person berechnet',
    },
    answers: [
      { icon: <IconCalendar />, label: 'Der Preis wird pro Person berechnet', name: 'person', inputType: 'number', info: '', onDay: false, isMultiField: false, placeholder: '' },
      { icon: <IconCalendar />, label: 'Der Preis wird anhand eines Gegenstandes/Raum/Bahn berechnet', name: 'object', inputType: 'number', info: '', onDay: false, isMultiField: false, placeholder: '' },
      { icon: <IconCalendar />, label: 'Der Preis wird Tagesabhängig anhand eines Gegenstandes/Raum/Bahn berechnet', name: 'onDayObject', inputType: 'dayPicker', info: 'Markiere die Tage an denen pro Gegstand/Raum oder Bahn berechnet wird.', onDay: true, isMultiField: false, placeholder: '' },
    ],
  },
  {
    info: {
      ...
      icon: <IconBoxMultiple4 color="#ff375e" />,
      type: 'checkbox',
      availableActivated: false,
      availableText: '',
    },
  ...
  },
  {
    info: {
      ...
      advice: '',
      icon: <IconBoxMultiple5 color="#d4be21" />,
      type: 'radio',
      availableActivated: true,
  ...
  },
  {
    info: {
      ...
      icon: <IconBoxMultiple6 color="#0983fe" />,
      type: 'radio',
      availableActivated: true,
  ...
  },
  {
    info: {
      ...
      icon: <IconBoxMultiple7 color="#fea00a" />,
      type: 'radio',
      availableActivated: true,
