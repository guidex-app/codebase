...
const StructureQuestions: Questions[] = [
  ...
  },
  {
    ...
    answers: [
      { icon: <Calendar />, label: 'Es wird pro Person berechnet', name: 'person', inputType: 'number', info: '', onDay: false, isMultiField: false, placeholder: '' },
      { icon: <Calendar />, label: 'Anhand eines Gegenstandes/Raum/Bahn berechnet', name: 'object', inputType: 'number', info: '', onDay: false, isMultiField: false, placeholder: '' },
      { icon: <Calendar />, label: 'Tagesabhängig anhand eines Gegenstandes/Raum/Bahn', name: 'onDayObject', inputType: 'dayPicker', info: '', onDay: true, isMultiField: false, placeholder: '' },
    ],
  },
  {
    info: {
