...
const Chooser: FunctionalComponent<ChooserProps> = ({ action, day, city }: ChooserProps) => (
  <div class={style.chooser}>
    ...
    <button class={style.second} onClick={() => action('Filter')} type="button" aria-label="Sonnig" tabIndex={0}><IconSun color="#581e0d" fill="#581e0d" size={22} /><small>Sonnig</small></button>
